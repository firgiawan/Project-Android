...
public class BuatParkir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_parkir);
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("insert into parkir(no, nama_mobil, jenis_mobil, plat, jam_masuk, jam_keluar, lokasi) values('" +
